  	...
  	<div class="admin-content">
    	<div class="admin-content-body">
      	<div class="am-cf am-padding">
			...
			<form class="am-form" method="post" action="${pageContext.request.contextPath}/admin/article/add.do">
				<div class="am-g am-margin-top">
            	<div class="am-u-sm-4 am-u-md-2 am-text-right">链接</div>
              	<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                	<input type="text" class="am-input-sm">
              	</div>
              	<div class="am-hide-sm-only am-u-md-6">
              		<button type="button" class="am-btn am-btn-primary am-btn-xs" onclick="fetch(this)">抓取</button>
              	</div>
            </div>
            ...
            <div class="am-g am-margin-top-sm">
              	...
              	<div class="am-u-sm-12 am-u-md-10">
                	<textarea name="content" rows="20" placeholder="请输入内容"></textarea>
              	</div>
            </div>
		  		<div class="am-margin">
...
<script type="text/javascript">
	...
	// 抓取
	function fetch(obj) {
		var linkUrl = $(obj).parent().prev().children('input').val();
		if (linkUrl == '') {
			alert('请先输入链接');
			return;
		}
		var regx = /^http[s]?:[/]{2}.+/;
		if (!regx.test(linkUrl)) {
			alert('请输入正确的链接');
			return;
		}
		// 抓取按钮设为不可点击
		$(obj).attr('disabled', 'disabled');
		$(obj).html('<i class="am-icon-spinner am-icon-spin"></i> 抓取中');
		$.get("${pageContext.request.contextPath}/admin/article/fetch.do", {linkUrl : linkUrl}, function(data) {
			$(obj).removeAttr('disabled');
			$(obj).html('抓取');
			editor.appendHTML(data);
		});
	}
</script>
</body>
